...
HUMAN_RECOVERY_RATE = 1 / HUMAN_INFECTED_STEPS  # assumes 1 step is 1 day
HUMAN_RECOVERED_STEPS = 5
HUMAN_RECOVERY_EXPIRE_RATE = 1 / HUMAN_RECOVERED_STEPS

DEFAULT_DAIRY_HERD_SIZE = 50
CATTLE_INFECT_HUMAN_PROB = .1
CATTLE_INFECT_CATTLE_PROB = .05
CATTLE_RECOVERY_PROB = .1
CATTLE_RECOVERY_END_PROB = .2
